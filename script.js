                ...
                if (pointer + 3 < splitWord.length) {
                   ...
                   translate(1);
                    ...
                    for (var i = 0; i < result.length; i++) {
                        document.getElementById("result").innerHTML += `<div class='element'><span class='element-number'>${elementsSymbols.indexOf(result[i]) + 1}</span>${result[i]}<span class='element-name'>${elementsFullNames[elementsSymbols.indexOf(result[i])]}</span></div>`;
                    }
                    return;
                }
            } else {
